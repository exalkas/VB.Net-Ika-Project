Public Class farmaka_add

    Private Sub C1Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles C1Button1.Click
        If Me.C1TextBox1.Text = "" Or Me.C1TextBox2.Text = "" Or Me.C1TextBox3.Text = "" Or Me.C1TextBox4.Text = "" Or Me.C1TextBox5.Text = "" Then
            MessageBox.Show("Τα πεδία Κωδικός ΕΟΦ, Κωδικός Barcode, Ονομασία Φαρμάκου, Κωδικός Εταιρείας και Ονομασία Εταιρείας είναι υποχρεωτικά. Παρακαλώ συμπληρώστε αυτά που λείπουν.")
            Exit Sub
        End If
    ...
    Private Sub farmaka_add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
