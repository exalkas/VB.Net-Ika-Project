...
Me.table_iatroi.DataTable.Rows.Item(0).Item(6)
    ...
    Private Sub sintages_add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Me.C1TextBox2.DataSource = Nothing
        Me.C1TextBox3.DataSource = Nothing
        Me.C1TextBox4.DataSource = Nothing
        Me.C1TextBox7.DataSource = Nothing
        Me.C1TextBox21.DataSource = Nothing
        Me.C1TextBox22.DataSource = Nothing
        ...
        Me.C1TextBox2.DataSource = table_iatroi
        Me.C1TextBox3.DataSource = table_asfalismenoi
        Me.C1TextBox4.DataSource = table_farmakeia
        Me.C1TextBox7.DataSource = table_farmaka1
        Me.C1TextBox21.DataSource = table_farmaka2
        Me.C1TextBox22.DataSource = table_farmaka3
    ...
    Private Sub C1Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles C1Button1.Click
        ...
        With SqlCommand1
            .Parameters.AddWithValue("code", C1TextBox1.Text)
        ...
        MessageBox.Show("Επιτυχής Εισαγωγή.")
        clear_form_sintages_add()
    End Sub
